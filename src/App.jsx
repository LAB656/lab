    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <article className="bg-white p-8 md:p-12 border border-stone-300 shadow-xl">
        ...
        <div className="flex flex-wrap items-center gap-2 mb-6">
          <span className="text-xs font-bold uppercase tracking-widest text-stone-400 mr-1">Compartir:</span>
          <a
            href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(window.location.href)}`}
            target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-1.5 bg-[#1877F2] text-white text-xs font-bold px-3 py-1.5 hover:opacity-90 transition-opacity"
          ...
          <a
            ...
            target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-1.5 bg-black text-white text-xs font-bold px-3 py-1.5 hover:opacity-90 transition-opacity"
            title="Compartir en X"
          >
            <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.73-8.835L1.254 2.25H8.08l4.26 5.632L18.244 2.25zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77z"/></svg>
            X
          </a>
          <a
            href={`https://wa.me/?text=${encodeURIComponent(selectedArticle.title + ' ' + window.location.href)}`}
            target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-1.5 bg-[#25D366] text-white text-xs font-bold px-3 py-1.5 hover:opacity-90 transition-opacity"
          ...
          <a
            ...
            target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-1.5 bg-[#229ED9] text-white text-xs font-bold px-3 py-1.5 hover:opacity-90 transition-opacity"
          ...
          <a
            href={`mailto:?subject=${encodeURIComponent(selectedArticle.title)}&body=${encodeURIComponent((selectedArticle.subtitle ? selectedArticle.subtitle + '\n\n' : '') + window.location.href)}`}
            className="flex items-center gap-1.5 bg-stone-700 text-white text-xs font-bold px-3 py-1.5 hover:opacity-90 transition-opacity"
